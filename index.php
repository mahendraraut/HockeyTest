        ...
        <div id="container" class="container">
            ...
            <?php if (DeviceDetector::$isAndroidDevice) { ?>
                ...
                ?>
                    ...
                    ?>
                        ...
                        <a class="button" href="<?php echo $b . '/' . $app[AppUpdater::INDEX_DIR] ?>?format=apk">Install Application</a>
            ...
            <?php } else if (DeviceDetector::$isNewIOSDevice) { ?>
                ...
                ?>
                    ...
                    ?>
                        ...
                        <a class="button" href="<?php echo $b . '/' . $app[AppUpdater::INDEX_DIR] ?>?format=mobileprovision">Install Profile</a>
                    <?php } ?>
                        <a class="button" href="itms-services://?action=download-manifest&amp;url=<?php echo urlencode($b . '' . $app[AppUpdater::INDEX_DIR] . "?format=plist") ?>">Install Application</a>
                    <?php if ($app[AppUpdater::INDEX_NOTES]) : ?>
                        <p><br/><br/></p>
                        <p><b>What's New:</b><br/><?php echo $app[AppUpdater::INDEX_NOTES] ?></p>
                    <?php endif ?>
            ...
            <?php } else { ?>
                ...
                ?>
                    ...
                    <?php if (isset($app[AppUpdater::INDEX_PROFILE]) && $app[AppUpdater::INDEX_PROFILE]) : ?>
                            <a class="button" href="<?php echo $b . '/' . $app[AppUpdater::INDEX_DIR] ?>?format=mobileprovision">Download Profile </a>
                    <?php endif;
                    if ($app[AppUpdater::INDEX_PLATFORM] == AppUpdater::APP_PLATFORM_IOS) : ?>
